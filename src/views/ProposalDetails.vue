                ...
                <div class="d-flex flex-column" v-for="(vote) in voteList.records" :key="vote.id">
                  <div class="row mb-4">
                    ...
                    <div class="col-4 col-lg-4 text-center fw-medium">
                      {{ detail.choices[vote.choice] }}
                    </div>
                    <div class="col-4 col-lg-4 text-right fw-medium d-flex justify-content-end align-items-center align-content-center">
                      <div class="mr-3">{{ vote.vp }} FDO</div>
                      <svg xmlns="http://www.w3.org/2000/svg" @click="showVoucher({...vote})" width="16" height="16" fill="currentColor" style="cursor: pointer;" class="bi bi-globe" viewBox="0 0 16 16">
                      ...
                      <input type="button" style="display: none;width: 0;height: 0;" id="showVoteInfoModeBtn" data-toggle="modal" data-target="#voteInfoModal" />
                    </div>
                  </div>
                </div>
              </template>
          ...
          <div class="container p-20 mt-4" style="border-radius: 10px; box-shadow: 0px 4px 24px 0px rgb(16 27 82 / 8%)">
            ...
            <div class="mb-4" v-for="(voteRes, index) in voteResult" :key="index">
              ...
              <div class="progress mb-1">
                <div class="progress-bar" role="progressbar" :style="{width: `${parseFloat(voteRes.rate).toFixed(2)}%`}" :aria-valuenow="parseFloat(voteRes.rate).toFixed(2)" aria-valuemin="0"
            ...
            <div v-if="!loadingVoteCheckInfo" class="alert" style="background-color: rgb(242, 244, 246)">
              <div class="row align-items-center justify-content-between">
                ...
                <div class="col-6 text-right">
                  {{ detail.choices[voteCheckInfo.choice] }}
                </div>
              </div>
...
import {voteSignModel} from "@/utils/model";
...
export default {
  ...
  methods: {
    ...
    async voteFun() {
      ...
      this.voteCheckInfo.choice = this.voteSelectIndex
    ...
    subVote() {
      ...
      signMessageJson['proposalIpfs'] = this.voteCheckInfo.proposalIpfs
