  ...
  <div class="container mt-5">
    <div class="row">
      <div class="col-lg-8">
        ...
        <div class="mb-4">
          <h3 class="font-weight-bold">{{ detail.title }}</h3>
        </div>
        <div class="mb-2">
              ...
              <div class="row mb-4">
                <div class="col-4 col-lg-4 d-flex">
                    <span class="mr-1"><img src="@/assets/images/eth_address.webp" class="rounded-circle shadow"
                                            style="width: 20px;"
                                            alt=""></span>
                  <span class="">{{vote.voter}}</span>
                </div>
                <div class="col-4 col-lg-4 text-center">{{vote.choice.map(ch => detail.choices[ch]).join(',')}}</div>
                <div class="col-4 col-lg-4 text-right">{{vote.vp}} FDO</div>
              </div>
            </div>
          </template>
        </div>
